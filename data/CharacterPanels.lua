...
A.CharacterPanelExact = {
    ...
    ["Filter"] = "Filtrar",
    ["Filters"] = "Filtros",
    -- Calendário (Blizzard_Calendar é carregado só quando o jogador abre a tela)
    ["January"] = "Janeiro",
    ["February"] = "Fevereiro",
    ["March"] = "Março",
    ["April"] = "Abril",
    ...
    ["Friday"] = "Sexta-feira",
    ["Saturday"] = "Sábado",
    ["Darkmoon Faire Begins"] = "Feira de Negraluna começa",
    ["Darkmoon Faire Ends"] = "Feira de Negraluna termina",
    ["Stranglethorn Fishing Extravaganza"] = "Fuzuê da Pesca da Selva do Espinhaço",
    ["Stranglethorn Fishing Extravaganza Begins"] = "Fuzuê da Pesca da Selva do Espinhaço começa",
    ["Stranglethorn Fishing Extravaganza Ends"] = "Fuzuê da Pesca da Selva do Espinhaço termina",
    ["All"] = "Todos",
